...
| C5 | Voice-parity spot pass (max 10 Vapi sessions) | IN PROGRESS 2026-07-04 (conductor re-scoped: includes explicit B31 pause/resume repro, 2 attempts max, console+network capture) | — |
