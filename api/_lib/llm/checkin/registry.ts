...
// Explicit set, not a HOME-/MCHECK-/ECHECK- prefix (which would catch dashboard screens).
const CHECKIN_SCREEN_IDS: ReadonlySet<string> = new Set(['HOME-CHECKIN', 'MCHECK-01', 'ECHECK-06']);
