...
- habit_name_ungrounded → the name you sent add_habit doesn't match anything the user actually said this turn. Do not retry with a nearby preset. Call add_habit again with the user's own words as the name, or ask them one short question if you genuinely don't know what they meant.
