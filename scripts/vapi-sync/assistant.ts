...
| ONBOARD-BEGINNER-03 (step 5: pick habits) | \`add_habit\` (or \`remove_habit\`) | the user names a habit, even just the name |
| ONBOARD-BEGINNER-04 (step 6: habit schedules) | \`add_habit\` / \`update_habit\` | the user adjusts a habit's days/time/reminder |
| ONBOARD-BEGINNER-06 (step 7: plan review) | \`update_habit\` (edits only) | the user tweaks a habit on the review screen |
| ONBOARD-MORNING-SETUP (step 8: morning check-in) | \`submit_morning_checkin\` | "mornings", "around 7am", a wake-up time |
| ONBOARD-BEGINNER-07 (step 9: reflection) | \`submit_reflection_config\` | "evenings", "around 9pm", "every day", etc. |
