-- 026_inject_anon_id_to_jwt.sql
-- Replaces custom_access_token_hook to inject anon_id + first_name into JWT
-- claims. Eliminates the per-request profiles SELECT in requireUser().
