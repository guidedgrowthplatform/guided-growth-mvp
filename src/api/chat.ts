...
export function createOrResumeChatSession(screenId: string): Promise<ChatSessionResponse> {
  return apiPost<ChatSessionResponse>('/api/chat/session', { screen_id: screenId });
}
