export function TypingIndicator() {
  return (
    <div className="mb-3 flex flex-col items-start">
      ...
      <div className="flex items-center gap-1.5 rounded-bl-2xl rounded-br-2xl rounded-tr-2xl border border-primary/20 bg-primary/50 px-4 py-3 backdrop-blur-[6px]">
