  ...
  return (
    <div className="min-h-[140px] w-full rounded-[16px] bg-white pb-[40px] pl-[20px] pr-0 pt-[20px] shadow-[0px_4px_20px_0px_rgba(0,0,0,0.05)]">
      <textarea
        ...
        className="w-full resize-none bg-transparent text-[15px] font-medium leading-[22px] text-[#0f172a] outline-none placeholder:text-[#d1d5db] [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-gray-300 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar]:w-[4px]"
        rows={5}
      />
    </div>
  );
