...
export const BEAT_METADATA: Record<string, BeatContextMeta> = {
  ...
  "ONBOARD-BEGINNER-01": {"voiceEngine": "MP3", "voiceMode": "Verbatim", "spokenContent": "Let's choose one area of your life that you'd like to improve on. Here are our recommended categories.", "allowedTools": "submit_category, advance_step", "openerShowsAsBubble": true, "expectedResponse": "Names or picks one category"},
  ...
  "ONBOARD-FORK--FORM": {"voiceEngine": "MP3", "voiceMode": "Verbatim", "spokenContent": "For the next part of the process, I'd like to know: Do you already track habits or is this new to you?", "allowedTools": "submit_path_choice, ask_clarification, advance_step", "openerShowsAsBubble": true, "expectedResponse": "New, or I already track habits"},
  "ONBOARD-MORNING-SETUP": {"voiceEngine": "MP3", "voiceMode": "Verbatim", "openerMode": "A", "allowedTools": "submit_morning_checkin, advance_step", "openerShowsAsBubble": false, "expectedResponse": "Sets a time and days", "perElement": [{"elementId": "schedule", "line": "Weekdays, weekends, or every day?", "order": 1, "showsAsBubble": false}, {"elementId": "when", "line": "What time?", "order": 2, "showsAsBubble": false}, {"elementId": "how-often", "line": "Or your own days.", "order": 3, "showsAsBubble": false}, {"elementId": "reminder", "line": "Want a reminder when it's time?", "order": 4, "showsAsBubble": false}]},
