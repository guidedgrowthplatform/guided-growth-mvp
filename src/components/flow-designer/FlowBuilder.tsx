...
// NON-AUTHORITATIVE (L1-4): this in-builder starter set is a design-time palette
// seed. The engine's source of truth is the Export JSON at
// src/onboarding-flow/flows/designer-source.json, transformed by flow:sync.
const DEFAULT_FLOW: DefaultBeat[] = [
  ...
  },
  {
    ...
    props: {
      coachLine: "Let's do your first one right now. How are you feeling in this exact moment?",
    },
  },
];
