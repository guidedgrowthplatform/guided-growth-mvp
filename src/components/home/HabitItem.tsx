...
// Lean habit row: name, streak, and the X/check completion pair only.
// Same as HabitListItem but without the note/reflection button. Use this in
// flow beats where the note action is not needed.
    ...
    <div className="relative overflow-hidden rounded-2xl">
      ...
      >
        <div className="min-w-0 flex-1">
          <p
            className={`truncate text-base font-bold text-content ${markStatus === 'done' ? 'line-through' : ''}`}
          >
            {name}
          </p>
