...
- `path-2-async` — daily check-ins, journal/feedback voice, single-utterance commands (MP3 + Soniox STT + callLLM + Cartesia Sonic; legacy REST + GPT-4o-mini NLU)
- `path-3-direct-llm` — direct-LLM implementation behind the three non-Vapi orb states (UX-26 States 2/3/4; cost-tier Path 2 for States 2/3, Path 3 for State 4)
