...
| UX-21 | Async reflection check-in pattern (NOT Vapi) | Check-ins use MP3 + Cartesia Ink + Cartesia Sonic API. Vapi is reserved for onboarding + feedback sessions. |
