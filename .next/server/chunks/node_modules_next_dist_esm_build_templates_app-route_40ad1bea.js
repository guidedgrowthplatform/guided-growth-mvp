...
Return ONLY the JSON object, no additional text.`;async function nE(e,t){let s=t||process.env.OPENAI_API_KEY;if(!s)return{result:{action:"unknown",entity:"unknown",params:{},confidence:0,error:"OPENAI_API_KEY not configured",rawResponse:""},latencyMs:0};let n=new nO({apiKey:s}),r=performance.now();try{let t=await n.chat.completions.create({model:"gpt-4o-mini",messages:[{role:"system",content:nI},{role:"user",content:e}],response_format:{type:"json_object"},temperature:.1,max_tokens:300}),s=Math.round(performance.now()-r),i=t.choices[0]?.message?.content||"{}";try{let e=JSON.parse(i);return{result:{action:e.action||"unknown",entity:e.entity||"unknown",params:e.params||{},confidence:"number"==typeof e.confidence?e.confidence:0,rawResponse:i,...e.error?{error:e.error}:{}},latencyMs:s}}catch{return{result:{action:"unknown",entity:"unknown",params:{},confidence:0,error:"Failed to parse GPT response as JSON",rawResponse:i},latencyMs:s}}}catch(t){let e=Math.round(performance.now()-r);return{result:{action:"unknown",entity:"unknown",params:{},confidence:0,error:`OpenAI API error: ${t instanceof Error?t.message:t}`,rawResponse:""},latencyMs:e}}}async function nP(e){try{let{transcript:t}=await e.json();if(!t||"string"!=typeof t)return eH.NextResponse.json({error:'Missing or invalid "transcript" field'},{status:400});let s=await nE(t);return eH.NextResponse.json(s)}catch(e){return console.error("Command processor error:",e),eH.NextResponse.json({error:`Server error: ${e instanceof Error?e.message:e}`},{status:500})}}e.s(["POST",()=>nP],71287);var nC=e.i(71287);let nT=new ek.AppRouteRouteModule({definition:{kind:eO.RouteKind.APP_ROUTE,page:"/api/process-command/route",pathname:"/api/process-command",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/src/app/api/process-command/route.ts",nextConfigOutput:"",userland:nC}),{workAsyncStorage:nN,workUnitAsyncStorage:nj,serverHooks:nM}=nT;function nD(){return(0,eI.patchFetch)({workAsyncStorage:nN,workUnitAsyncStorage:nj})}async function nL(e,t,s){nT.isDev&&(0,eE.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let n="/api/process-command/route";n=n.replace(/\/index$/,"")||"/";let r=await nT.prepare(e,t,{srcPage:n,multiZoneDraftMode:!1});if(!r)return t.statusCode=400,t.end("Bad Request"),null==s.waitUntil||s.waitUntil.call(s,Promise.resolve()),null;let{buildId:i,params:a,nextConfig:o,parsedUrl:l,isDraftMode:c,prerenderManifest:u,routerServerContext:h,isOnDemandRevalidate:d,revalidateOnlyGenerated:p,resolvedPathname:f,clientReferenceManifest:m,serverActionsManifest:g}=r,y=(0,eT.normalizeAppPath)(n),w=!!(u.dynamicRoutes[y]||u.routes[f]),_=async()=>((null==h?void 0:h.render404)?await h.render404(e,t,l,!1):t.end("This page could not be found"),null);if(w&&!c){let e=!!u.routes[f],t=u.dynamicRoutes[y];if(t&&!1===t.fallback&&!e){if(o.experimental.adapterPath)return await _();throw new eU.NoFallbackError}}let b=null;!w||nT.isDev||c||(b="/index"===(b=f)?"/":b);let v=!0===nT.isDev||!w,x=w&&!v;g&&m&&(0,eC.setManifestsSingleton)({page:n,clientReferenceManifest:m,serverActionsManifest:g});let S=e.method||"GET",$=(0,eP.getTracer)(),A=$.getActiveScopeSpan(),R={params:a,prerenderManifest:u,renderOpts:{experimental:{authInterrupts:!!o.experimental.authInterrupts},cacheComponents:!!o.cacheComponents,supportsDynamicResponse:v,incrementalCache:(0,eE.getRequestMeta)(e,"incrementalCache"),cacheLifeProfiles:o.cacheLife,waitUntil:s.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,s,n,r)=>nT.onRequestError(e,t,n,r,h)},sharedContext:{buildId:i}},k=new eN.NodeNextRequest(e),O=new eN.NodeNextResponse(t),I=ej.NextRequestAdapter.fromNodeNextRequest(k,(0,ej.signalFromNodeResponse)(t));try{let r=async e=>nT.handle(I,R).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let s=$.getRootSpanAttributes();if(!s)return;if(s.get("next.span_type")!==eM.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${s.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let r=s.get("next.route");if(r){let t=`${S} ${r}`;e.setAttributes({"next.route":r,"http.route":r,"next.span_name":t}),e.updateName(t)}else e.updateName(`${S} ${n}`)}),i=!!(0,eE.getRequestMeta)(e,"minimalMode"),a=async a=>{var l,f;let m=async({previousCacheEntry:o})=>{try{if(!i&&d&&p&&!o)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let n=await r(a);e.fetchMetrics=R.renderOpts.fetchMetrics;let l=R.renderOpts.pendingWaitUntil;l&&s.waitUntil&&(s.waitUntil(l),l=void 0);let c=R.renderOpts.collectedTags;if(!w)return await (0,eL.sendResponse)(k,O,n,R.renderOpts.pendingWaitUntil),null;{let e=await n.blob(),t=(0,eB.toNodeOutgoingHttpHeaders)(n.headers);c&&(t[eq.NEXT_CACHE_TAGS_HEADER]=c),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let s=void 0!==R.renderOpts.collectedRevalidate&&!(R.renderOpts.collectedRevalidate>=eq.INFINITE_CACHE)&&R.renderOpts.collectedRevalidate,r=void 0===R.renderOpts.collectedExpire||R.renderOpts.collectedExpire>=eq.INFINITE_CACHE?void 0:R.renderOpts.collectedExpire;return{value:{kind:eF.CachedRouteKind.APP_ROUTE,status:n.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:s,expire:r}}}}catch(t){throw(null==o?void 0:o.isStale)&&await nT.onRequestError(e,t,{routerKind:"App Router",routePath:n,routeType:"route",revalidateReason:(0,eD.getRevalidateReason)({isStaticGeneration:x,isOnDemandRevalidate:d})},!1,h),t}},g=await nT.handleResponse({req:e,nextConfig:o,cacheKey:b,routeKind:eO.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:u,isRoutePPREnabled:!1,isOnDemandRevalidate:d,revalidateOnlyGenerated:p,responseGenerator:m,waitUntil:s.waitUntil,isMinimalMode:i});if(!w)return null;if((null==g||null==(l=g.value)?void 0:l.kind)!==eF.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==g||null==(f=g.value)?void 0:f.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});i||t.setHeader("x-nextjs-cache",d?"REVALIDATED":g.isMiss?"MISS":g.isStale?"STALE":"HIT"),c&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let y=(0,eB.fromNodeOutgoingHttpHeaders)(g.value.headers);return i&&w||y.delete(eq.NEXT_CACHE_TAGS_HEADER),!g.cacheControl||t.getHeader("Cache-Control")||y.get("Cache-Control")||y.set("Cache-Control",(0,eW.getCacheControlHeader)(g.cacheControl)),await (0,eL.sendResponse)(k,O,new Response(g.value.body,{headers:y,status:g.value.status||200})),null};A?await a(A):await $.withPropagatedContext(e.headers,()=>$.trace(eM.BaseServerSpan.handleRequest,{spanName:`${S} ${n}`,kind:eP.SpanKind.SERVER,attributes:{"http.method":S,"http.target":e.url}},a))}catch(t){if(t instanceof eU.NoFallbackError||await nT.onRequestError(e,t,{routerKind:"App Router",routePath:y,routeType:"route",revalidateReason:(0,eD.getRevalidateReason)({isStaticGeneration:x,isOnDemandRevalidate:d})},!1,h),w)throw t;return await (0,eL.sendResponse)(k,O,new Response(null,{status:500})),null}}e.s(["handler",()=>nL,"patchFetch",()=>nD,"routeModule",()=>nT,"serverHooks",()=>nM,"workAsyncStorage",()=>nN,"workUnitAsyncStorage",()=>nj],84553)}];

//# sourceMappingURL=node_modules_next_dist_esm_build_templates_app-route_40ad1bea.js.map