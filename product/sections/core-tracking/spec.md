# Core Tracking Specification

## Overview

The foundation of Guided Growth App - seamless daily data entry for habit tracking and journaling. Users can log habits, track consistency, maintain streaks, and journal their reflections through form or spreadsheet views with multi-modal input support. This section handles all daily data capture, habit management, and journaling management after the initial onboarding is complete.
